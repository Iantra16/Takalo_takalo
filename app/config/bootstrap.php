...
/*
 * This is the bootstrap file which loads all the required services, 
 * plugins, connections, etc. for every request made to the application.
 */
...
/*
 * Load helpers - Global functions for views
 */
require(__DIR__ . $ds . '..' . $ds . 'helpers.php');
