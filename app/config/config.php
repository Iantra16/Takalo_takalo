...
/**********************************************
 *      FlightPHP Application Configuration   *
 **********************************************
 *
...
$app->set('flight.base_url', null);           // Base URL for your app. Change if app is in a subdirectory
...
$app->set('flight.views.extension', '.php');  // View file extension
