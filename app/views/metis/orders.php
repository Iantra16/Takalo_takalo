...
$pageTitle = 'Order Management - Modern Bootstrap Admin';
$pageDescription = 'Comprehensive order management with tracking, fulfillment, and analytics';
$pageKeywords = 'bootstrap, admin, dashboard, orders, e-commerce, tracking';
$pageName = 'orders';
$currentPage = 'orders';
$bodyClass = 'order-management';
$additionalScripts = '<script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
<script type="module" crossorigin src="/assets/assets-metis/orders-Cge2POod.js"></script>';
