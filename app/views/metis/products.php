...
$pageTitle = 'Product Management - Modern Bootstrap Admin';
$pageDescription = 'Comprehensive product management with inventory tracking, categories, and analytics';
$pageKeywords = 'bootstrap, admin, dashboard, products, inventory, e-commerce';
$pageName = 'products';
$currentPage = 'products';
$bodyClass = 'product-management';
$additionalScripts = '<script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
<script type="module" crossorigin src="/assets/assets-metis/products-WhFVlziX.js"></script>';
