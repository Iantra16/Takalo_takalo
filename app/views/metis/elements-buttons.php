...
$pageTitle = 'Buttons - Bootstrap 5 Elements';
$pageDescription = 'Bootstrap 5 button examples - styles, sizes, states, and variations';
$pageKeywords = 'bootstrap, buttons, primary, secondary, success, danger, warning, info';
$pageName = 'elements';
$currentPage = 'elements-buttons';
