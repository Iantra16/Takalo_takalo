...
$pageTitle = 'Reports & Analytics - Modern Bootstrap Admin';
$pageDescription = 'Comprehensive reporting and analytics with interactive charts and data export';
$pageKeywords = 'bootstrap, admin, dashboard, reports, analytics, charts, data';
$pageName = 'reports';
$currentPage = 'reports';
$bodyClass = 'reports-page';
$additionalScripts = '<script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
<script type="module" crossorigin src="/assets/assets-metis/reports-De8TCLfm.js"></script>';
