...
$pageTitle = 'Analytics Dashboard - Modern Bootstrap Admin';
$pageDescription = 'Comprehensive analytics dashboard with advanced charts, KPIs, and data visualizations';
$pageKeywords = 'bootstrap, admin, dashboard, analytics, charts, data visualization';
$pageName = 'analytics';
$currentPage = 'analytics';
$bodyClass = 'analytics-page';
$additionalScripts = '<script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
<script type="module" crossorigin src="/assets/assets-metis/analytics-Baa0JPJM.js"></script>';
