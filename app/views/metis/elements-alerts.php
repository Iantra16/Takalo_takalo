...
$pageTitle = 'Alerts - Bootstrap 5 Elements';
$pageDescription = 'Bootstrap 5 alert examples - contextual feedback messages for user actions';
$pageKeywords = 'bootstrap, alerts, notifications, feedback, primary, success, danger, warning';
$pageName = 'elements';
$currentPage = 'elements-alerts';
