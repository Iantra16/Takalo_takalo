...
$pageTitle = 'File Manager - Modern Bootstrap Admin';
$pageDescription = 'Advanced file management system with cloud storage and collaboration';
$pageKeywords = 'bootstrap, admin, dashboard, files, documents, storage, upload';
$pageName = 'files';
$currentPage = 'files';
$bodyClass = 'files-page';
$additionalScripts = '<script type="module" crossorigin src="/assets/assets-metis/files-IAw2DBec.js"></script>';
