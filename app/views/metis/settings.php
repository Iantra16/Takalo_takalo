...
$pageTitle = 'Settings & Preferences - Modern Bootstrap Admin';
$pageDescription = 'Application settings and user preferences configuration';
$pageKeywords = 'bootstrap, admin, dashboard, settings, preferences, configuration';
$pageName = 'settings';
$currentPage = 'settings';$bodyClass = 'settings-page';$additionalScripts = '<script type="module" crossorigin src="/assets/assets-metis/settings-Be2-aZA2.js"></script>';
