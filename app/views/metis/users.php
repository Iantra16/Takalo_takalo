...
$pageTitle = 'User Management - Modern Bootstrap Admin';
$pageDescription = 'Advanced user management with data tables, CRUD operations, and bulk actions';
$pageKeywords = 'bootstrap, admin, dashboard, users, data tables, CRUD';
$pageName = 'users';
$currentPage = 'users';
$bodyClass = 'user-management';
$additionalScripts = '<script src="https://cdn.jsdelivr.net/npm/apexcharts"></script>
<script type="module" crossorigin src="/assets/assets-metis/users-B_8qHPdr.js"></script>';
