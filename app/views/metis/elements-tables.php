...
$pageTitle = 'Tables - Bootstrap 5 Elements';
$pageDescription = 'Bootstrap 5 table examples - responsive design, striped, bordered, and hover styles';
$pageKeywords = 'bootstrap, tables, responsive, striped, bordered, hover, data tables';
$pageName = 'elements';
$currentPage = 'elements-tables';
