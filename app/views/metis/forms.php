...
$pageTitle = 'Advanced Forms - Modern Bootstrap Admin';
$pageDescription = 'Advanced form examples with real-time validation, file uploads, and multi-step wizards';
$pageKeywords = 'bootstrap, admin, dashboard, forms, validation';
$pageName = 'forms';
$currentPage = 'forms';
$bodyClass = 'admin-layout';
$additionalScripts = '<script type="module" crossorigin src="/assets/assets-metis/forms-CC-rf4V3.js"></script>';
