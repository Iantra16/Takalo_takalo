...
$pageTitle = 'Help & Support - Modern Bootstrap Admin';
$pageDescription = 'Get help, find documentation, and access support resources for the admin dashboard';
$pageKeywords = 'bootstrap, admin, dashboard, help, support, documentation, FAQ, contact';
$pageName = 'help';
$currentPage = 'help';
$bodyClass = 'help-page';
$additionalScripts = '<script type="module" crossorigin src="/assets/assets-metis/help-Bv3zbO-2.js"></script>';
