...
$pageTitle = 'Bootstrap 5 Elements - Modern Bootstrap Admin';
$pageDescription = 'Bootstrap 5 basic elements showcase - buttons, alerts, badges, cards, modals and more';
$pageKeywords = 'bootstrap, elements, components, buttons, alerts, badges, cards, modals';
$pageName = 'elements';
$currentPage = 'elements';
$bodyClass = 'elements-page';
$additionalScripts = '<script type="module" crossorigin src="/assets/assets-metis/elements-CKTxkm6E.js"></script>';
