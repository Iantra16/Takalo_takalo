...
$pageTitle = 'Security & Authentication - Modern Bootstrap Admin';
$pageDescription = 'Security settings, authentication, and access control management';
$pageKeywords = 'bootstrap, admin, dashboard, security, authentication, 2FA, access control';
$pageName = 'security';
$currentPage = 'security';$bodyClass = 'security-page';$additionalScripts = '<script type="module" crossorigin src="/assets/assets-metis/security-DHdfSIuE.js"></script>';
