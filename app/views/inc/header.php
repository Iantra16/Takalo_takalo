<?php
// Configuration de la page (à définir avant d'inclure le header)
// $pageTitle - Titre de la page
// $pageDescription - Description meta
// $pageKeywords - Mots-clés meta
// $pageName - Nom de la page pour data-page et classes CSS
// $additionalScripts - Scripts supplémentaires (optionnel)

$pageTitle = $pageTitle ?? 'Dashboard - Modern Bootstrap Admin';
$pageDescription = $pageDescription ?? 'Modern Bootstrap 5 Admin Template';
$pageKeywords = $pageKeywords ?? 'bootstrap, admin, dashboard, template';
$pageName = $pageName ?? 'dashboard';
$bodyClass = $bodyClass ?? 'admin-layout';  // Classe CSS du body (ex: messages-page, analytics-page, etc.)
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="/assets/assets-metis/favicon-CvUZKS4z.svg">
    <link rel="icon" type="image/png" href="/assets/assets-metis/favicon-B_cwPWBd.png">
    ...
    <!-- PWA Manifest -->
    <link rel="manifest" href="/assets/assets-metis/manifest-DTaoG9pG.json">
    
    <!-- Core Scripts & Styles -->
    <script type="module" crossorigin src="/assets/assets-metis/vendor-bootstrap-C9iorZI5.js"></script>
    <script type="module" crossorigin src="/assets/assets-metis/vendor-charts-DGwYAWel.js"></script>
    <script type="module" crossorigin src="/assets/assets-metis/vendor-ui-CflGdlft.js"></script>
    <script type="module" crossorigin src="/assets/assets-metis/main-DwHigVru.js"></script>
    <?php echo $additionalScripts; ?>
    <link rel="stylesheet" crossorigin href="/assets/assets-metis/main-QD_VOj1Y.css">
</head>

<body data-page="<?php echo htmlspecialchars($pageName); ?>" class="<?php echo htmlspecialchars($bodyClass); ?>">
    <!-- Loading Screen -->
        ...
        <header class="admin-header">
            <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
                <div class="container-fluid">
                    <!-- Logo/Brand -->
                    <a class="navbar-brand d-flex align-items-center" href="/metis/index">
